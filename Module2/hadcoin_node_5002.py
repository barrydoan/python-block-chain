...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': 'Damm. The blookchain is not valid'}
    return jsonify(response), 200
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The Hadcoin blockchain now contain the',
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes havs different chains so the chain was replaced by the longest one',
